  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" className="w-min gap-1 px-2" size="sm" aria-label={buttonAriaLabel}>
      ...
      <DropdownMenuContent className="w-40" align="start">
        {FONT_FAMILY_OPTIONS.map((option) => (
          <DropdownMenuItem key={option} style={{ fontFamily: option }} onClick={() => handleClick(option)}>
            {option}
          </DropdownMenuItem>
        ))}
      </DropdownMenuContent>
