...
import { useVirtualizer, type VirtualItem, type Virtualizer, type VirtualizerOptions } from "@tanstack/react-virtual";
...
function DataGridTableVirtualStatusRow({
  ...
  return (
    <tr>
      <td colSpan={columnCount} className={cn("py-4 text-center text-muted-foreground text-sm", className)}>
        {children}
      </td>
    </tr>
  );
...
export type { DataGridTableVirtualizerOptions, DataGridTableVirtualProps, DataGridTableVirtualScrollElements };
