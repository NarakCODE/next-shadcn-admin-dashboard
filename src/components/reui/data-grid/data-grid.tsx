...
import type { Column, ColumnFiltersState, RowData, SortingState, Table } from "@tanstack/react-table";
...
function DataGridContainer({
  ...
  return (
    <div
      data-slot="data-grid"
      className={cn("w-full overflow-hidden", border && "rounded-lg border border-border", className)}
    >
      {children}
    </div>
  );
...
export { DataGrid, DataGridContainer, DataGridProvider, DataGridTable, useDataGrid };
