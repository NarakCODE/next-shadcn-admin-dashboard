  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 text-center">
      ...
      <div className="relative z-10">
        <h1 className="font-medium text-4xl/none tracking-tight">Service Unavailable</h1>
        <p className="mx-auto mt-5 max-w-sm text-lg text-muted-foreground">
          The server is temporarily unable to handle your request. Please try again in a moment.
        </p>
