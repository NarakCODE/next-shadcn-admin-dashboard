...
import { ArrowLeft, Calendar, Eye, ImagePlus, Plus, Save, X } from "lucide-react";
...
export default function BlogCreatePage() {
  ...
  const [status, setStatus] = useState<"draft" | "published" | "scheduled" | "inactive">("draft");
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="mb-6 space-y-1">
        <h1 className="text-3xl tracking-tight">Create New Post</h1>
        <p className="text-muted-foreground text-sm">Write and publish a new blog article</p>
      </div>
